...
import salesData from "../saledata.json"; 
...
function Sales() {
  ...
  const filteredSales = salesData.filter((sale) =>
    [sale.ProductName, sale.Category, sale.SaleDate]
      .join(" ")
      .toLowerCase()
